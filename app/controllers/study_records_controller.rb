class StudyRecordsController < ApplicationController
  ...
  def create
    ...
    if @study_record.save
      redirect_to study_records_path, success: "学習記録を投稿しました"
    else
  ...
  def update
    if @study_record.update(study_record_params)
      redirect_to study_record_path(@study_record), success: "学習記録を編集しました"
    else
  ...
  def destroy
    ...
    redirect_to study_records_path, status: :see_other, danger: "学習記録を削除しました"
  end
